        ...
        <CardContent className="space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Start a conversation to analyze market trends or get blockchain insights.</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Request detailed analysis of blockchain data and market metrics.</p>
            </div>
          </div>
        </CardContent>
      </Card>
